...
# Can be found in discord.py server, just search for your old messages @Voctor
...
class EmbedHelpCommand(commands.HelpCommand):
    ...
    async def send_bot_help(self, mapping):
        embed = discord.Embed(title='Wellness Commands', colour=self.COLOUR)
        embed.description = 'Made for XdHacks-LA'
...
class HelpCommand(commands.Cog, name='Information'):
